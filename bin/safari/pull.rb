...
import_file = (Lagrange::CLI.clint.options[:import] != "") ? Lagrange::CLI.clint.options[:import] : Lagrange::Safari::DEFAULT_BOOKMARKS_PATH
import_as = (Lagrange::CLI.clint.options[:as] != "") ? Lagrange::CLI.clint.options[:as] : Lagrange::Safari::DEFAULT_DATASET
