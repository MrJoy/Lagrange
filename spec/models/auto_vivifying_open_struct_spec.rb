describe Lagrange::AutoVivifyingOpenStruct do
  ...
  describe "#new" do
    it "should accept a hash" do
      s = Lagrange::AutoVivifyingOpenStruct.new(foo: "something", "baz" => 123)

      recursively_check(s)
    end

    it "should recursively turn a deep hash into auto-vivifying structs" do
      s = Lagrange::AutoVivifyingOpenStruct.new(foo: { bar: { baz: { blah: 123 }}})
  ...
  describe "#method_missing" do
    it "should auto-vivify arbitrarily deep properties" do
      s = Lagrange::AutoVivifyingOpenStruct.new
  ...
  describe "#as_json" do
    it "should convert the entire hierarchy into a simple hash" do
      s = Lagrange::AutoVivifyingOpenStruct.new(foo: { bar: { baz: { blah: 123 }}}).as_json
